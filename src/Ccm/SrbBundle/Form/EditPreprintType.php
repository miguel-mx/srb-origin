...
class EditPreprintType extends AbstractType
{
 public function buildForm(FormBuilder $builder, array $options)
 {
  ...
  ->add('type', 'choice', array('choices'=>array('preprint'=>'Preprint', 'article'=>'Article', 'incollection'=>'Incollection', 'proceedings'=>'Proceedings', 'book'=>'Book', 'inproceedings'=>'Inproceedings')))
